...
public class SQLDatabase extends Database
{
	...
	public SQLDatabase(FoxBot foxbot)
	{
		this.foxbot = foxbot;
	}
	...
	{
		Statement statement;
		String url = String.format("jdbc:mysql://%s:%s/%s", foxbot.getConfig().getDatabaseHost(), foxbot.getConfig().getDatabasePort(), foxbot.getConfig().getDatabaseName());
